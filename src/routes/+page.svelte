<script>
  ...
  const stats = [
    { num: '4.4K', label: 'Social engagement', sub: 'TPUSA coverage'   },
    { num: '1.8K', label: 'TikTok views',       sub: 'Gaza kids at SFO' },
    { num: '3',    label: 'Languages',           sub: 'ES · PT · FR'    },
    { num: '15+',  label: 'Bylines at BCN',      sub: 'Bay City News'   },
  ];
...
<svelte:head>
  <title>Andres Jimenez Larios — Multimedia Reporter</title>
  ...
  <div class="container">
    <div class="row align-items-center g-5">
      <div class="col-12 col-lg-7">
        <p class="eyebrow mb-4 {mounted ? 'fade-up' : 'opacity-0'}">Multimedia Data Reporter · Bay City News</p>
        <h1 class="{mounted ? 'fade-up delay-1' : 'opacity-0'} mb-3">
          Reporting where<br><em>data meets story.</em>
        </h1>
        <p class="hero-sub mb-4 {mounted ? 'fade-up delay-2' : 'opacity-0'}">
          From San Francisco transit funding fights to rural Mexico healthcare crisis —
          data-driven storytelling, maps, and multimedia journalism from the Bay Area.
        </p>
      ...
      <div class="col-12 col-lg-5 d-none d-lg-block {mounted ? 'fade-up delay-3' : 'opacity-0'}">
        <div class="row g-3">
          {#each stats as s, i}
            <div class="col-6">
              <div class="stat-card">
  ...
  <a href="https://alariosjx.github.io/hours_from_oxygen/" target="_blank" rel="noopener" class="rp-card d-block">
    <div class="row align-items-center g-4">
      <div class="col-12 col-md-8">
        ...
        <h2 class="card-title" style="font-size:1.75rem">El Viaje Eterno</h2>
        <p class="card-desc">Economic and social inequalities in rural Mexico revealed during COVID-19 continue to plague vulnerable communities with poor healthcare outcomes. A multimedia documentary built on field reporting, video, photography, and data.</p>
        <div class="card-meta">
      ...
      <div class="col-12 col-md-4 d-none d-md-flex align-items-center justify-content-center">
        <div style="background:var(--blue-pale);border:1px solid rgba(44,95,138,0.15);border-radius:1rem;height:160px;width:100%;padding:1rem;display:flex;flex-direction:column;gap:0.5rem;">
          <div style="display:flex;align-items:flex-end;gap:3px;flex:1">
            {#each [45,62,38,81,54,70,43,90,61,77] as h}
              <div style="border-radius:3px 3px 0 0;flex:1;height:{h}%;background:var(--blue);opacity:0.25;transition:opacity 0.3s;"></div>
            {/each}
          </div>
          <div style="font-family:var(--mono);font-size:0.55rem;letter-spacing:0.1em;text-transform:uppercase;color:rgba(44,95,138,0.45)">Healthcare access · Oaxaca · 2020-24</div>
        </div>
      </div>
    </div>
  </a>
  ...
  <div class="row g-3">
    <div class="col-12 col-lg-6">
      <div class="rp-card h-100">
        ...
        <h2 style="font-size:1.75rem;margin-bottom:0.9rem">Andres<br>Jimenez Larios</h2>
        <p style="font-size:1rem;font-weight:300;color:var(--muted);line-height:1.8;margin-bottom:1.25rem">
        ...
        <a href="{base}/about" class="btn-blue" style="font-size:0.7rem">Full bio →</a>
      </div>
    </div>
    <div class="col-12 col-md-6 col-lg-3">
      <div class="rp-card alt h-100">
        ...
        <h3 style="font-size:1.2rem;margin-bottom:0.4rem">SF Fog Rugby</h3>
        <p style="font-size:0.95rem;font-weight:300;color:var(--muted);line-height:1.65">
